        ...
        {stats.map((stat, index) => {
          ...
          return (
            <div key={index} className="stat-col">
              <div className="card shadow-sm stat-card-bs">

                <div className="d-flex align-items-center gap-3">

                  <div
                    className="stat-icon-bs"
                    style={{
                      background: `${stat.color}18`,
                      color: stat.color
                    }}
                  ...
                  <div className="flex-grow-1">
                    <div className="stat-label-bs">{stat.label}</div>
                    <div className="stat-value-bs">{stat.value}</div>
                  </div>
